...
<?php 
 ...
 echo "<td>"."<a href=\"/ingenieria/VistaItemProceso.php?id_itemproceso=".$filaItemproceso['id_itemproceso']."\" >".$filaItemproceso['ItemProceso']."</a></td>\n";
...
mysqli_close($mysqli);
echo "<a href=\"/ingenieria/ListProceso.php\"><img src=\"../img/BtnVolver.png\" alt=\"BtnVolver\" width=\"60\" height=\"40\"></a>";
}
