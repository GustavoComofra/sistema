...
<form action="/sistema/Reclamo/insertarReclamo.php" method="post" name="formReclamo" enctype="multipart/form-data">
...
?>		
	...
	<label for="txtAnalisisCausa"><p>Analisis Causa:</p></label>	      
			<input name="txtAnalisisCausa" type="text" id="txtAnalisisCausa" title="Analisis Causa" size="100" /></td>
    </tr>	
 ...
 <tr>
	...
	<label for="txtRespAccion"><p>Accion correctiva:</p></label>		 
		<textarea name="txtRespAccion" rows="2" cols="100" id="txtRespAccion" title="RespAccion" ></textarea></td>
	</tr>
	...
	<label for="txtEvalEfica"><p>Evaluacion Eficaz:</p></label>	      
			<input name="txtEvalEfica" type="text" id="txtEvalEfica" size="100" title="EvalEfica"/></td>
    </tr>
	
	    <tr>
	<td>	
	<label for="txtRespEvaluc"><p>Respuesta Evalucion:</p></label>	      
			<input name="txtRespEvaluc" type="text" id="txtRespEvaluc" size="100" title="EvalEfica"/></td>
    </tr>
