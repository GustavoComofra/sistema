...
$carpetas_destino1='ftp.planidear.com.ar/img/' . $nombre_imagen1;
...
$carpetas_destino2='ftp.planidear.com.ar/img/' . $nombre_imagen2;
...
$carpetas_destino3='ftp.planidear.com.ar/img/' . $nombre_imagen3;
...
$carpetas_destinoSolu='ftp.planidear.com.ar/img/' . $nombre_imagenSolu;
...
$carpetas_destinoSolu1='ftp.planidear.com.ar/img/' . $nombre_imagenSolu1;
...
$carpetas_destinoSolu2='ftp.planidear.com.ar/img/' . $nombre_imagenSolu2;
...
$carpetas_destinoSolu3='ftp.planidear.com.ar/img/' . $nombre_imagenSolu3;
...
$mensaje="Reclamo: ".$_POST['txtReclamo']." Chasis: ".$_POST['txtChasis']." Fecha: ".$_POST['txtFecha']."Para revisarlo: https://planidear.com.ar/sistema/index.php";
//$para="gustavog@live.com.ar,sgc@comofrasrl.com.ar,calidad2@comofrasrl.com.ar,producto@comofrasrl.com.ar,repuestos@comofrasrl.com.ar,gerenciageneral@comofrasrl.com.ar,gerenciaproduccion@comofrasrl.com.ar,producto1@comofrasrl.com.ar,procesos@comofrasrl.com.ar";
$para="gustavog@live.com.ar";

$cabeceras = 'From: industrialg@comofrasrl.com.ar>';
