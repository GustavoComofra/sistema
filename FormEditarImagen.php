...
echo "<td>".'<img  src="'.$rowReclamoImagen['Imagen'].'" style="border-radius: " width="100" heigth="100"/>'."</td>\n";
			?>
...
$EditarRegistro = "UPDATE `ComReclamo` SET `Imagen` = '$Imagen' WHERE `ComReclamo`.`IdReclamo` = ".$IdReclamo.";";
