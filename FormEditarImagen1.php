...
<div class="form-group" align="">
  <table class="table" width="423"  border="0">
    <tr>
      <td colspan="3" align="center"><label for="txtFalla">Imagen1</label></td>
    </tr>
    <tr>
		<td width="156">id</td>
	<td width="156">Num</td>	
	<td width="156">Imagen1</td>
...
echo "<td>".'<img  src="'.$rowReclamoImagen['Imagen1'].'" style="border-radius: " width="100" heigth="100"/>'."</td>\n";
			?>
...
$Imagen1 = 'https://interno.comofrasrl.com.ar/sistema/img/venta/'.$nombre_imagen;
...
$EditarRegistro = "UPDATE `ComReclamo` SET `Imagen1` = '$Imagen1' WHERE `ComReclamo`.`IdReclamo` = ".$IdReclamo.";";
