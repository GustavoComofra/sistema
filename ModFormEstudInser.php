...
<label>
        <input type="submit" class="btn-outline-info" name="btnEnviar" id="btnEnviar" value="Buscar" />
      </label>	
...
<table border=1 align=\"\" class=\"table table-striped\">
  <thead>
<th colspan=\"5\" align=\"center\" bgcolor=\"#5D81F5\"><span class=\"\">Estudios</th>
 </thead>
</tr>
<TR>
<TD><B>IdEstudio</B></TD>
...
include("Conexion/conexion.php");	
$queryEsudio = $mysqli -> query ("SELECT * FROM `ComEstudios` WHERE `Estudio` LIKE '%$Estudio%' AND `Institucion` LIKE '%$Institucion%' ORDER BY `ComEstudios`.`Estudio` ASC");
  
 while ($filaEsudio = mysqli_fetch_array($queryEsudio))

{
echo "<TR>\n";
echo "<td>".$filaEsudio['IdEstudio']."</td>\n";
$varCuit=$filaEsudio['IdEstudio'];
echo "<td>".$filaEsudio['Estudio']."</td>\n";
echo "<td>".$filaEsudio['Institucion']."</td>\n";
echo "<td>".$filaEsudio['Descripcion']."</td>\n";

	 
echo "<td>"." <img src=\"../sistema/img/EditIcono.png\" alt=\"BtnIconoEditar\" width=\"20\" height=\"20\" longdesc=\"Boton Editar\">"."<a href=\"#?IdEstudio=".$filaEsudio['IdEstudio']."\"></a></td>\n";	 
	 
echo "<td>"." <img src=\"../sistema/img/BorrIcono.png\" alt=\"BtnIconoBorrar\" width=\"20\" height=\"20\" longdesc=\"Boton Editar\">"."<a href=\"#?IdEstudio=".$filaEsudio['IdEstudio']."\"></a></td>\n"; 
