...
<link href="../sistema/img/Icono.png" rel="icon" type="image/png">
 <title>Editar imagen Solucion1</title>
...
<div class="form-group" align="">
  <table class="table" width="423"  border="0">
    <tr>
      <td colspan="3" align="center"><label for="txtFalla">Imagen Solucion 1</label></td>
    </tr>
    <tr>
		<td width="156">id</td>
	<td width="156">Num</td>	
...
echo "<td>".'<img  src="'.$rowReclamoImagen['ImagenSolu1'].'" style="border-radius: " width="100" heigth="100"/>'."</td>\n";
			?>
...
$ImagenSolu1 = 'https://interno.comofrasrl.com.ar/sistema/img/venta/'.$nombre_imagen;	
...
$EditarRegistro = "UPDATE `ComReclamo` SET `ImagenSolu1` = '$ImagenSolu1' WHERE `ComReclamo`.`IdReclamo` = ".$IdReclamo.";";
