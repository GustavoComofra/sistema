  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-auto">
        ...
        <form action="/sistema/EditarReclamo.php" method="post" name="formEditarReclamo" enctype="multipart/form-data">
            ...
            <table class="table" width="" border="0">
              ...
              <tr>
                <td>
                  ...
                  while ($valoresConcesionario1 = mysqli_fetch_array($queryConcesionario1)) {
                    ...
                    $varvaloresConcesionarioNum = $valoresConcesionario1['NumReclamo'];
              ...
              <tr>
                <td>
                  ...
                  $queryCliente1 = $mysqli->query("SELECT * FROM `ComVisClieRecla` WHERE `NumReclamo` = " . $NumReclamo . "; ");


                  while ($valoresCliente1 = mysqli_fetch_array($queryCliente1)) {


                    $varvaloresClienteNum = $valoresCliente1['Id_Cliente'];
...
<?php print $rowReclamo['RespEvaluc']; ?></textarea>
              ...
              <tr>
                <td>
                  ...
                  <input name="txtSup" type="text" id="txtSup" size="2" maxlength="2" title="Sup" value="<?php print $rowReclamo['Sup']; ?>" />
                </td>
