...
<link href="../sistema/img/Icono.png" rel="icon" type="image/png">
 <title>Editar imagen Solucion3</title>
...
<div class="form-group" align="">
  <table class="table" width="423"  border="0">
    <tr>
      <td colspan="3" align="center"><label for="txtFalla">Imagen Solucion 3</label></td>
    </tr>
    <tr>
		<td width="156">id</td>
	<td width="156">Num</td>	
...
$ImagenSolu3 = 'https://interno.comofrasrl.com.ar/sistema/'.$nombre_imagen;		
