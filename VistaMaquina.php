...
$queryMaquinaVista = $mysqli -> query ("SELECT * FROM `Maquinaria` WHERE `idMaq` = ".$idMaq.";");

$rowMaquinaVista = mysqli_fetch_assoc($queryMaquinaVista);
		?>
...
<td colspan="2" rowspan="2">   <div align="center"><h1>Vista Maquina</h1>
