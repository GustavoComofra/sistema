...
<style>
	...
	<title>Borrar estudio personal</title>
<body>
...
<table class="table table-hover">
    <tr>
      <td colspan="4"  ><strong><h2>Borrar Estudio Personal</h2></strong>
        
         <label for="txtCUIT_Empl">Id:</label>
   <input name="txtCUIT_Empl" type="text" id="txtCUIT_Empl" size="1" value="<?php print $IdEstudPersonal;?>" > 
