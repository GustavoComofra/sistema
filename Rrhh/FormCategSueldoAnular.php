...
<title>Anular Formulario categoria de sueldo</title>
<body>
<div class="m-0">
		<?php
...
<thead>
    <tr>
      <td colspan="8"  ><label>Anular Concepto x categoria</label></td>
...
<div  >
  <table width="" border="1" class="table table-striped">
    <tr>
      <td colspan="5"  ><label>Anular concepto sueldo</label>
