...
<div class="container text-center">
  <div class="row">
	...
	$queryOrganigramaGG = $mysqli -> query ("SELECT * FROM `ComEmpleado` WHERE `Sector` = 19 AND `Encargado` = 19 AND `Gerente` = 19 AND `Gerente_General` = 19 AND `Baja` LIKE 'No' ORDER BY `Apellidos` ASC");
...
?>
	...
	
	{
		...
		echo "<a href=../Rrhh/VistaPersonal.php?IdPersonal=".$filaOrganigramaEnFi['IdPersonal']."\" target=\"_blank\">
	...
	echo "<td><a href=../Rrhh/VistaPersonal.php?IdPersonal=" . $filaOrganigramaEnFiCol['IdPersonal'] . "\" target=\"_blank\">
...
<?php
	...
	echo "<td>"."<a href=../Rrhh/VistaPersonal.php?IdPersonal=".$filaOrganigramaSerGen['IdPersonal']."\" target=\"_blank\">
