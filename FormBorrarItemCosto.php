...
<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" name="formFallaCosto" enctype="multipart/form-data">

<div class="form-group" align="">
  <table class="table" width="423"  border="0">
    <tr>
      <td colspan="8" align="center"><label for="txtCosto">Borrar Costo de reclamo</label></td>
    </tr>
    <tr>
	<td width="156">Num</td>	
	<td width="156">Id</td>
