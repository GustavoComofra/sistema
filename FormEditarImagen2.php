...
<div class="form-group" align="">
  <table class="table" width="423"  border="0">
    <tr>
      <td colspan="3" align="center"><label for="txtFalla">Imagen2</label></td>
    </tr>
    <tr>
		<td width="156">id</td>
	<td width="156">Num</td>	
...
echo "<td>".'<img  src="'.$rowReclamoImagen['Imagen2'].'" style="border-radius: " width="100" heigth="100"/>'."</td>\n";
			?>
...
$Imagen2 = 'https://interno.comofrasrl.com.ar/sistema/img/venta/'.$nombre_imagen;	
...
$EditarRegistro = "UPDATE `ComReclamo` SET `Imagen2` = '$Imagen2' WHERE `ComReclamo`.`IdReclamo` = ".$IdReclamo.";";
