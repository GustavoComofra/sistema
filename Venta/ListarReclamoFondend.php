...
"columns":[
	...
	"render": function (data, type, JsonResultRow, meta) {
		 return "<a href='/sistema/Venta/VistaReclamo.php?NumReclamo="+JsonResultRow.NumReclamo+"' target='_blank'><img src='/sistema/img/VerIcono.png' alt='BtnIconoVer' width='20' height='20'></a>"
		 +" &emsp;"+"<a href='/sistema/Venta/FormReclamoEditar.php?NumReclamo="+JsonResultRow.NumReclamo+"' target='_blank'><img src='/sistema/img/EditIcono.png' alt='EditIcono.png' width='20' height='20' ></a>"; 
	}},
],
dom: 'Bfrtip',
                buttons: [
