...
"columns":[
	...
	"render": function (data, type, JsonResultRow, meta) {
		 ...
		 +" &emsp;"+"<a href='/sistema/MaquinariaEditar.php?idMaq="+JsonResultRow.idMaq+"' target='_blank'><img src='/sistema/img/EditIcono.png' alt='EditIcono.png' width='20' height='20' ></a>"
		 +" &emsp;"+"<a class='list-borrar' href='/sistema/FormMaquiBorrar.php?idMaq="+JsonResultRow.idMaq+"' target='_blank'><img src='/sistema/img/BorrIcono.png' alt='BorrIcono.png' width='20' height='20' ></a>"; 
	}},
],
dom: 'Bfrtip',
                buttons: [
