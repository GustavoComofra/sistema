...
<form name="formSal" method="post" action="http://interno.comofrasrl.com.ar/sistema/InsSal.php">
 <table width="200" border="1" align="center">
   <tbody>
     <tr>
       <th align="center" scope="col"><h1 class="alert-link EncaDescrip"><strong>SALIDA</strong></h1>
        <p Class="DescParrafo"><strong>ingresar su CUIT</strong></p></th>
     </tr>
     <tr>
       <td>	
<input class="red-input"  name="codigoSal" type="text" autofocus="autofocus" id="codigoSal" title="Codigo"  onkeyup="validaCuitSal()">
<h1 id="AvPruebaSal" class="ColorAvPrueba"></h1>
 <?php
$DiaSal = date("Y-m-d"); 
$HoraSal = date("H:i:s"); 
$time = time();
