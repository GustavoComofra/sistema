...
<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" name="formImagenReclamo" enctype="multipart/form-data">

<div class="form-group" align="">
  <table class="table" width="423"  border="0">
    <tr>
      <td colspan="3" align="center"><label for="txtFalla">Imagen3</label></td>
    </tr>
    <tr>
		<td width="156">id</td>
	<td width="156">Num</td>	
	<td width="156">Imagen2</td>
...
echo "<td>".'<img  src="'.$rowReclamoImagen['Imagen3'].'" style="border-radius: " width="100" heigth="100"/>'."</td>\n";
			?>
...
$Imagen3 = 'https://interno.comofrasrl.com.ar/sistema/img/venta/'.$nombre_imagen;
...
$EditarRegistro = "UPDATE `ComReclamo` SET `Imagen3` = '$Imagen3' WHERE `ComReclamo`.`IdReclamo` = ".$IdReclamo.";";
