            ...
            <table class="table" width="" border="0">
              <tr>
                <td colspan="2" align="left">
                  ...
                  <label ><h1>Borrar registro inventario</h1></label>
                </td></tr>
                <tr>
                <td colspan="2" align="left">
...
<option value="Si">Si</option>             
                ...
                <tr>
                <td colspan="2" align="left">
          <input type="submit" class="btn btn-danger" name="btnEditar" id="btnEditar" value="Borrar"  />
          </td></tr>
            </table>
          </div>
...
$EditarRegistroInventario = "DELETE FROM Inventario WHERE `Inventario`.`idInventario` = ".$idInventario.";";
